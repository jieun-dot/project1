...
# tokenizer 저장
import pickle
with open('tokenizer_data_ko.pkl', 'wb') as handle:
...
#mc = ModelCheckpoint('best_model_ml2.h5', monitor='val_acc', mode='max', verbose=1, save_best_only=True)
...
model.save('ko_model.h5')

loaded_model = load_model('ko_model.h5')
